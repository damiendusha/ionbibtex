...
#ifndef METADATA_CONFERENCE_H
#define METADATA_CONFERENCE_H

#include "CMetadataElement.h"

class CMetadataConference : public CMetadataElement 
{
    public:

        CMetadataConference();
        virtual ~CMetadataConference();
