...
#include "CPublicationJournal.h"

#include "MetadataElement/CMetadataAbstract.h"
#include "MetadataElement/CMetadataAuthor.h"
#include "MetadataElement/CMetadataIssue.h"
#include "MetadataElement/CMetadataVolume.h"
#include "MetadataElement/CMetadataJournal.h"
...
#include "MetadataElement/CMetadataDoi.h"


CPublicationJournal::CPublicationJournal()
    : CPublication("article")
{
    m_metadata.push_back(new CMetadataTitle());
    m_metadata.push_back(new CMetadataAuthor());
    m_metadata.push_back(new CMetadataJournal());
    m_metadata.push_back(new CMetadataVolume());
    m_metadata.push_back(new CMetadataIssue());
    ...
    m_metadata.push_back(new CMetadataDoi());
}
